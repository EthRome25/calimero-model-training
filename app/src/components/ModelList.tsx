...
export default function ModelList({
  ...
  const getModelTypeDescription = (type: string) => {
    const descriptions: { [key: string]: string } = {
      tumor_classifier: 'Advanced AI model for tumor detection and classification in medical imaging',
      segmentation: 'Deep learning model for precise image segmentation and region identification',
      detection: 'Computer vision model for object detection and localization tasks',
      regression: 'Machine learning model for predictive analysis and numerical predictions',
      classification: 'AI model for categorizing and classifying data into predefined classes',
    };
    return descriptions[type] || 'Machine learning model for data analysis and prediction';
  };
    ...
    return (
      <div className="empty-state">
        ...
        <p className="empty-state__description">
          Upload your first machine learning model to get started with secure, peer-to-peer AI model sharing.
        </p>
      </div>
    );
  }
          ...
          <div className="horizontal-card__content">
            ...
            <div className="horizontal-card__main">
              ...
              <div className="horizontal-card__meta">
                ...
                <span className={`horizontal-card__badge ${model.is_public ? 'horizontal-card__badge--secondary' : ''}`}>
