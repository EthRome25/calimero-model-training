  ...
  if (!modelSummary) {
    return (
      <div className="empty-state">
        ...
        <p className="empty-state__description">
          No model summary data available.
        </p>
      </div>
    );
  }
    ...
    >
      ...
      >
        <div className="professional-header__content">
          <div>
            <h1 className="professional-header__title">
              Model Training Summary
            </h1>
            <p className="professional-header__subtitle">
              Comprehensive performance analysis and training metrics for the
              latest model
            </p>
          </div>
        ...
        <div className="horizontal-card__content">
          ...
          <div className="horizontal-card__main">
            ...
            <p className="horizontal-card__description">
              Advanced medical image classification model with state-of-the-art
              performance metrics
            </p>
            <div className="horizontal-card__meta">
              ...
              <span
                className={`horizontal-card__badge ${
                  modelSummary.status === 'completed'
                    ? 'horizontal-card__badge--primary'
                    : 'horizontal-card__badge--secondary'
                }`}
              >
                {modelSummary.status.charAt(0).toUpperCase() +
                  modelSummary.status.slice(1)}
              </span>
              <span className="horizontal-card__badge">
                Last Updated:{' '}
                {new Date(modelSummary.lastUpdated).toLocaleDateString()}
              </span>
            </div>
          </div>
        </div>
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(181, 255, 17, 0.1) 0%, rgba(181, 255, 17, 0.05) 100%)',
      ...
      >
        ...
        >
          ...
          <div>
            <h2
              className="horizontal-card__title"
          ...
          {/* Row 2, Col 2: Stats */}
          <div
            className="horizontal-card__stats"
            style={{
              paddingTop: 0,
              borderTop: 'none',
              margin: 0,
          ...
          >
            <div className="horizontal-card__stat">
              <div
                className="horizontal-card__stat-value"
                style={{ fontSize: '3rem' }}
              >
                {modelSummary.accuracy.toFixed(2)}%
              </div>
              <div className="horizontal-card__stat-label">Accuracy</div>
            </div>
            <div className="horizontal-card__stat">
              <div className="horizontal-card__stat-value">
                {modelSummary.precision.toFixed(2)}%
              </div>
              <div
                className="horizontal-card__stat-label"
            ...
            <div className="horizontal-card__stat">
              <div className="horizontal-card__stat-value">
                {modelSummary.f1Score.toFixed(2)}%
              </div>
              <div
                className="horizontal-card__stat-label"
                style={{ color: 'var(--text-primary)' }}
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                {modelSummary.validationLoss.toFixed(3)}
              </p>
            </div>
          </div>
        </div>
